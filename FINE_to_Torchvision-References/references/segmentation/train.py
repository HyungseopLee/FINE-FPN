...
def main(args):
    ...
    model.eval()
    with torch.no_grad():
        input = torch.randn(1, 3, 520, 520).to(device)
...
# fcn_resnet50 (original: $NGPU x 8, b 4 -> total batch size 32)

torchrun --nproc_per_node=2 train.py \
--print-freq 100 \
--lr 0.02 --dataset coco -b 16 --data-path /media/data/coco \
--model fcn_resnet50 --aux-loss --weights-backbone ResNet50_Weights.IMAGENET1K_V1 \
--output-dir ./outputs/fcn_resnet50/baseline \
2>&1 | tee ./outputs/fcn_resnet50/baseline/train.log
