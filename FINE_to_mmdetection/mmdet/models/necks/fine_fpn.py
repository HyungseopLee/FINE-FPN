...
class FINEFPN(BaseModule):
    ...
    def __init__(
        ...
        print(f"len(self.lateral_convs): {len(self.lateral_convs)}")
     
        for i in range(2):
            is_first = (i == 0)
            self.fine.append(
                FeatureInteractionNEtowrk(
                    dim=hidden_dim,
                    nhead=16,
                    dropout=0.0,
                    activation='gelu',
