...
class BUSpatialAlignTransnormer(nn.Module):
    def __init__(self, c1, c2, nhead=16, is_first=False, is_yolov6=False, dropout=0.0, activation="gelu"):
        '''
        c1: #channels of low-level feature map
        c2: #channels of high-level feature map
        '''
    ...
    def forward(self, a3, a4):
        ...
        # print(f"Input shapes: a3: {a3.shape}, a4: {a4.shape}")
        ...
        # print(f"\t After pooling shapes: a3: {a3.shape}, a4: {a4.shape}")
